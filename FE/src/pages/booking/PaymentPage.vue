...
const applyVoucher = () => {
  if (discountCode.value === 'CINE20') {
    ElMessage.success('Voucher applied! 20% discount.');
  } else {
    ElMessage.error('Invalid voucher code');
  }
};
...
<template>
  <div class="payment-page container py-5">
    <h2 class="fw-bold mb-4">Review & Payment</h2>
      ...
      <div class="col-lg-8">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
          <h5 class="fw-bold mb-4 d-flex align-items-center">
            <el-icon class="me-2 text-primary"><Tickets /></el-icon> Order Details
          </h5>
          
          <div class="row align-items-center mb-4">
            <div class="col-md-2 col-4">
              <img 
                src="https://via.placeholder.com/150x225/111827/ffffff?text=Poster" 
            ...
            <div class="col-md-10 col-8">
              ...
              <p class="text-secondary small">Sunday, Feb 8, 2026 • {{ bookingStore.showtimeTime }}</p>
              <div class="d-flex gap-2 mt-2">
                <span class="badge bg-light text-dark">{{ bookingStore.seatsCount }} Seats</span>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
          <h5 class="fw-bold mb-4 d-flex align-items-center">
            <el-icon class="me-2 text-primary"><Wallet /></el-icon> Payment Method
          </h5>
          ...
          <div class="d-grid gap-3">
            ...
            >
              <div class="d-flex align-items-center gap-3">
                ...
                <span class="fw-bold">VNPay Wallet / Banking</span>
              </div>
            ...
            >
              <div class="d-flex align-items-center gap-3">
                ...
                <span class="fw-bold">International Credit/Debit Card</span>
              </div>
      ...
      <div class="col-lg-4">
        <div class="card border-0 shadow-lg rounded-4 sticky-top" style="top: 100px;">
          <div class="p-4 bg-white">
            ...
            <!-- Voucher -->
            <div class="mb-4">
              <label class="small text-secondary fw-bold text-uppercase mb-2 d-block">Voucher Code</label>
              <div class="d-flex gap-2">
                <el-input v-model="discountCode" placeholder="Enter code" />
                <el-button type="primary" @click="applyVoucher">Apply</el-button>
              </div>
              <p class="small text-secondary mt-2 mb-0">Try <strong>CINE20</strong> for 20% off</p>
            </div>
