  ...
  <div class="form-page-container">
    <div class="form-header-modern">
      ...
      <div class="d-flex gap-3">
        <el-button :icon="Opportunity" @click="handleOpenPreview" class="btn-cine-action-outline">Xem trước</el-button>
        <el-button @click="router.back()" class="btn-cine-action-outline">Hủy bỏ</el-button>
        <el-button type="primary" :icon="Check" @click="handleSubmit" :loading="saving" class="btn-premium-action-main px-4">
    ...
    <div class="row g-4">
      <div class="col-lg-8">
        ...
        <div class="form-card-premium p-4 px-5">
          <div class="fw-bold fs-5 text-dark mb-4 pb-2 border-bottom">
            <i class="bi bi-ticket-perforated me-2"></i>Thông tin chương trình
          </div>
          <el-form :model="form" label-position="top" class="premium-form">
            <div class="row g-3">
              <div class="col-md-6">
                <el-form-item label="Mã Voucher (Hệ thống tự động)" required>
        ...
        <div class="form-card-premium p-4 px-5">
          <div class="fw-bold fs-5 text-dark mb-4 pb-2 border-bottom">
            <i class="bi bi-gear-fill me-2"></i>Trạng thái & Ghi chú
          </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="form-card-premium p-4">
          <div class="fw-bold fs-5 text-dark mb-4 pb-2 border-bottom">
            <i class="bi bi-cash-stack me-2"></i>Cấu hình giảm giá
          </div>
          <div class="row g-3">
            <div class="col-12">
        ...
        <div class="form-card-premium p-5">
          <div class="d-flex justify-content-between align-items-start mb-4">
            <div>
              ...
              <p class="text-secondary small mb-0">Đã chọn: <span class="text-primary fw-bold">{{
                  selectedCustomers.length
                  }}</span> khách hàng</p>
            </div>

            <div class="d-flex align-items-center gap-2 flex-wrap">
              <el-input v-model="customerSearch" placeholder="Tìm theo mã / tên / SĐT / email..." size="default"
                style="width: 320px" :prefix-icon="Search" clearable @input="fetchCustomers" />
          ...
          <div class="customer-full-table">
            <BaseTable ref="customerTableRef" :data="customers" :columns="customerColumns" :loading="customerLoading"
              :total="totalCustomers" :show-actions="false" v-model:selection="selectedCustomers"
    ...
    <BaseModal v-model="previewVisible" title="Xem trước hiển thị Voucher" width="500px" icon="bi bi-lightbulb"
      isDetail>
