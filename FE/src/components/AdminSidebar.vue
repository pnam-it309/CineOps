<template>
  <div class="d-flex flex-column h-100 bg-dark text-white">
    <div
      class="d-flex align-items-center justify-content-center gap-2 p-3 text-white fw-bold fs-4 border-bottom border-light border-opacity-10 admin-header"
      style="height: 60px;">
      ...
      <transition name="fade">
        ...
        <span v-else class="fs-5">QC</span>
      </transition>
    </div>
