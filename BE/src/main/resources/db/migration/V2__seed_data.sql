...
-- 2. PHÒNG CHIẾU
INSERT INTO phong_chieu (id, id_rap, ten_phong, loai_man_hinh, tong_ghe, nguoi_tao)
VALUES ('pc-001-uuid-001', 'RAP-001', 'Phòng 01', 'IMAX 3D', 40, 'system'),
...
VALUES (UUID(), 'kg-02-uuid', 'pc-001-uuid-001', 'P1', CURDATE(), 40, 1, 'system'),
       (UUID(), 'kg-04-uuid', 'pc-001-uuid-001', 'P2', CURDATE(), 40, 1, 'system'),
       (UUID(), 'kg-03-uuid', 'pc-002-uuid-002', 'P3', CURDATE(), 30, 1, 'system'),
       (UUID(), 'kg-05-uuid', 'pc-002-uuid-002', 'P4', CURDATE(), 30, 2, 'system'),
       (UUID(), 'kg-01-uuid', 'pc-001-uuid-001', 'P5', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 40, 1, 'system'),
       (UUID(), 'kg-02-uuid', 'pc-001-uuid-001', 'P6', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 40, 1, 'system');
